...
public class ArithmeticTest {
  ...
  public void testCountOfVariables() throws Exception {
      ...
      StatisticFunctionFactory.addFunction(statisticFunction);

      program.load(lines);
      ArrayList<Integer> data = statisticFunction.dataContainer;
      assertEquals((int)data.get(0), 5);
  }
  ...
  @Test
  public void testMultiplyFunctions() throws Exception {
      Program program = new Program();
      ArrayList<String> lines = new ArrayList<>();
      lines.add("var x = 2 + 6");
      lines.add("    var y = x + 8");
      ...
      PrintVariablesFunction statisticFunction2 = new PrintVariablesFunction();
      StatisticFunctionFactory.addFunction(statisticFunction2);
      ...
      ArrayList<String> data2 = statisticFunction2.dataContainer;
      assertEquals(data2.get(0), "x");
      assertEquals(data2.get(1), "y");
      assertEquals(data2.get(2), "x");
      assertEquals(data2.get(3), "q");
      assertEquals(data2.get(4), "z");
  }
}
